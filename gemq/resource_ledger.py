...
The ledger is self-contained so GEMQ does not depend on another project for
experiment metadata. It mirrors the public resource fields used by the paired
quantization runner while keeping GEMQ's command-level execution model.
"""
...
def _visible_gpu_ids() -> list[int]:
    """Map local CUDA indices to the physical IDs selected for this command."""
...
class ResourceLedger:
    """Record wall time and PyTorch allocator peaks for one command."""
